...
Analysis of leiden resolution, cluster sizes, and COSMIC enrichment within clusters.

Used to generate Figure S4c
...
files = list.files(path = "./__data", pattern="FI.fusion_table.scaled.umap.leiden.res.*tsv.gz")
...
for (filename in files) {
    ...
    resolution = str_replace(filename, "FI.fusion_table.scaled.umap.leiden.res", "")
