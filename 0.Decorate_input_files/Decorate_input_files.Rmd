...
orig_starF_fusions_FULL$annot_adj = str_replace(orig_starF_fusions_FULL$annot_adj, 
                                                      "NEIGHBORS_OVERLAP", "LOCAL_REARRANGEMENT")
orig_starF_fusions_FULL$annot_adj = str_replace(orig_starF_fusions_FULL$annot_adj, "LOCAL_INVERSION", "LOCAL_REARRANGEMENT") 
...
orig_starF_fusions_FULL = orig_starF_fusions_FULL %>% mutate(structure_type = ifelse(grepl("LOCAL_REARRANGEMENT", annot_adj),
